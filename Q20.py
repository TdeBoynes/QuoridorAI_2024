...
##                    visited.pop()
    ...
    def place_random_wall(self):
        ...
        for move in legal_moves:
            if (move[0] == 'H' and move[1] > 0 and move[1] < board_size-2) or (move[0] == 'V' and move[1] > 0 and move[1] < board_size-2):
    ...
    def draw_log(self):
        ...
        for i, move in enumerate(player1_moves):
            ...
            window.blit(text, (WIDTH + 100, 50 + i * 15))
